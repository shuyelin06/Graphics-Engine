...
namespace Physics
{
GJKSupportPointSet::GJKSupportPointSet(const Transform* _transform)
    : points()
{
...
const std::vector<Vector3>& GJKSupportPointSet::getPoints()
{
    return points;
}
...
// direction
const Vector3 GJKSupportPointSet::furthestPoint(const Vector3& direction) const
{
    if (points.size() == 0)
    {
