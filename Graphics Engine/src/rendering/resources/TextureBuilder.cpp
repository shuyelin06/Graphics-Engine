...
// Reset:
// Resets the builder
void TextureBuilder::reset(unsigned int width, unsigned int height,
...
bool TextureBuilder::hasTextureColor(const MipLevel& mipLevel, unsigned int x,
                                     unsigned int y) {
...
UINT AtlasBuilder::getAtlasWidth() const { return mips[0].width; }
UINT AtlasBuilder::getAtlasHeight() const { return mips[0].height; }
