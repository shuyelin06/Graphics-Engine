...
namespace Datamodel
{
	...
	public:
		MarchingCube(float a1, float a2, float a3, float a4,
	...
	private:
		...
		bool testInternalAmbiguity(char caseID, char configID, char subConfigID, char sign);
	...
	*/
	...
	MarchingCube::MarchingCube(float a1, float a2, float a3, float a4,
		float a5, float a6, float a7, float a8)
	{
		vertexData[0] = a1;
		vertexData[1] = a2;
	...
	// Generates a surface for the marching cube. Assumes that data is loaded into vertexData.
	// This uses the Marching Cube algorithm, and assumes the surface exists at the value 0.
	void MarchingCube::generateSurface()
	{
		...
		case  4:
			if (testInternalAmbiguity(caseID, configID, subconfigID, TestTableCase4[configID]))
		...
		case  6:
			...
			{
				if (testInternalAmbiguity(caseID, configID, subconfigID, TestTableCase6[configID][1]))
		...
		case  7:
			if (testFaceAmbiguity(TestTableCase7[configID][0])) subconfigID += 1;
			if (testFaceAmbiguity(TestTableCase7[configID][1])) subconfigID += 2;
			if (testFaceAmbiguity(TestTableCase7[configID][2])) subconfigID += 4;
			switch (subconfigID)
			{
			case 0:
				createTriangles(TilingTableCase7_1[configID], 3); break;
			case 1:
				createTriangles(TilingTableCase7_2[configID][0], 5); break;
			case 2:
				createTriangles(TilingTableCase7_2[configID][1], 5); break;
			case 3:
				createTriangles(TilingTableCase7_3[configID][0], 9); break;
			case 4:
				createTriangles(TilingTableCase7_2[configID][2], 5); break;
			case 5:
				createTriangles(TilingTableCase7_3[configID][1], 9); break;
			case 6:
				createTriangles(TilingTableCase7_3[configID][2], 9); break;
			case 7:
				if (testInternalAmbiguity(caseID, configID, subconfigID, TestTableCase7[configID][3]))
		...
		case 10:
			if (testFaceAmbiguity(TestTableCase10[configID][0]))
			{
				if (testFaceAmbiguity(TestTableCase10 [configID][1]))
					createTriangles(TilingTableCase10_1_1_Inverted[configID], 4); // 10.1.1
				else
				{
			...
			else
			{
				if (testFaceAmbiguity(TestTableCase10[configID][1]))
				{
					createTriangles(TilingTableCase10_2_Inverted[configID], 8); // 10.2
				}
				else
				{
					if (testInternalAmbiguity(caseID, configID, subconfigID, TestTableCase10[configID][2]))
						createTriangles(TilingTableCase10_1_1[configID], 4); // 10.1.1
					else
						createTriangles(TilingTableCase10_1_2[configID], 8); // 10.1.2
				}
			}
			break;
		...
		case 12:
			if (testFaceAmbiguity(TestTableCase12[configID][0]))
			{
				if (testFaceAmbiguity(TestTableCase12[configID][1]))
					createTriangles(TilingTableCase12_1_1_Inverted[configID], 4); // 12.1.1
				else
				{
			...
			else
			{
				if (testFaceAmbiguity(TestTableCase12[configID][1]))
				{
					createTriangles(TilingTableCase12_2_Inverted[configID], 8); // 12.2
				}
				else
				{
					if (testInternalAmbiguity(caseID, configID, subconfigID, TestTableCase12[configID][2]))
						createTriangles(TilingTableCase12_1_1[configID], 4); // 12.1.1
					else
						createTriangles(TilingTableCase12_1_2[configID], 8); // 12.1.2
				}
			}
			break;

		case 13:
			if (testFaceAmbiguity(TestTableCase13[configID][0])) subconfigID += 1;
			if (testFaceAmbiguity(TestTableCase13[configID][1])) subconfigID += 2;
			if (testFaceAmbiguity(TestTableCase13[configID][2])) subconfigID += 4;
			if (testFaceAmbiguity(TestTableCase13[configID][3])) subconfigID += 8;
			if (testFaceAmbiguity(TestTableCase13[configID][4])) subconfigID += 16;
			if (testFaceAmbiguity(TestTableCase13[configID][5])) subconfigID += 32;
			switch (SubconfigTableCase13[subconfigID])
			{
			case 0:/* 13.1 */
				createTriangles(TilingTableCase13_1[configID], 4); break;

			case 1:/* 13.2 */
				createTriangles(TilingTableCase13_2[configID][0], 6); break;
			case 2:/* 13.2 */
				createTriangles(TilingTableCase13_2[configID][1], 6); break;
			case 3:/* 13.2 */
				createTriangles(TilingTableCase13_2[configID][2], 6); break;
			case 4:/* 13.2 */
				createTriangles(TilingTableCase13_2[configID][3], 6); break;
			case 5:/* 13.2 */
				createTriangles(TilingTableCase13_2[configID][4], 6); break;
			case 6:/* 13.2 */
				createTriangles(TilingTableCase13_2[configID][5], 6); break;

			case 7:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][0], 10); break;
			case 8:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][1], 10); break;
			case 9:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][2], 10); break;
			case 10:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][3], 10); break;
			case 11:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][4], 10); break;
			case 12:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][5], 10); break;
			case 13:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][6], 10); break;
			case 14:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][7], 10); break;
			case 15:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][8], 10); break;
			case 16:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][9], 10); break;
			case 17:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][10], 10); break;
			case 18:/* 13.3 */
				createTriangles(TilingTableCase13_3[configID][11], 10); break;

			case 19:/* 13.4 */
				createTriangles(TilingTableCase13_4[configID][0], 12); break;
			case 20:/* 13.4 */
				createTriangles(TilingTableCase13_4[configID][1], 12); break;
			case 21:/* 13.4 */
				createTriangles(TilingTableCase13_4[configID][2], 12); break;
			case 22:/* 13.4 */
				createTriangles(TilingTableCase13_4[configID][3], 12); break;

			case 23:/* 13.5 */
				subconfigID = 0;
				if (testInternalAmbiguity(caseID, configID, subconfigID, TestTableCase13[configID][6]))
			...
			case 27:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][0], 10); break;
			case 28:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][1], 10); break;
			case 29:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][2], 10); break;
			case 30:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][3], 10); break;
			case 31:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][4], 10); break;
			case 32:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][5], 10); break;
			case 33:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][6], 10); break;
			case 34:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][7], 10); break;
			case 35:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][8], 10); break;
			case 36:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][9], 10); break;
			case 37:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][10], 10); break;
			case 38:/* 13.3 */
				createTriangles(TilingTableCase13_3_Inverted[configID][11], 10); break;

			case 39:/* 13.2 */
				createTriangles(TilingTableCase13_2_Inverted[configID][0], 6); break;
			case 40:/* 13.2 */
				createTriangles(TilingTableCase13_2_Inverted[configID][1], 6); break;
			case 41:/* 13.2 */
				createTriangles(TilingTableCase13_2_Inverted[configID][2], 6); break;
			case 42:/* 13.2 */
				createTriangles(TilingTableCase13_2_Inverted[configID][3], 6); break;
			case 43:/* 13.2 */
				createTriangles(TilingTableCase13_2_Inverted[configID][4], 6); break;
			case 44:/* 13.2 */
				createTriangles(TilingTableCase13_2_Inverted[configID][5], 6); break;

			case 45:/* 13.1 */
				createTriangles(TilingTableCase13_1_Inverted[configID], 4); break;
	...
	Vector3 MarchingCube::generateVertexOnEdge(char edgeID)
	{
		...
		{
		case 0:
			basePoint = Vector3(0, 0, 0); baseValue = vertexData[0];
			offset = Vector3(1, 0, 0);	  offsetValue = vertexData[1];
			break;
		case 1:
			basePoint = Vector3(1, 0, 0); baseValue = vertexData[1];
			offset = Vector3(0, 1, 0);	  offsetValue = vertexData[2];
			break;
		case 2:
			basePoint = Vector3(1, 1, 0); baseValue = vertexData[2];
			offset = Vector3(-1, 0, 0);	  offsetValue = vertexData[3];
			break;
		case 3:
			basePoint = Vector3(0, 1, 0); baseValue = vertexData[3];
			offset = Vector3(0, -1, 0);	  offsetValue = vertexData[0];
			break;
		case 4:
			basePoint = Vector3(0, 0, 1); baseValue = vertexData[4];
			offset = Vector3(1, 0, 0);	  offsetValue = vertexData[5];
			break;
		case 5:
			basePoint = Vector3(1, 0, 1); baseValue = vertexData[5];
			offset = Vector3(0, 1, 0);	  offsetValue = vertexData[6];
			break;
		case 6:
			basePoint = Vector3(1, 1, 1); baseValue = vertexData[6];
			offset = Vector3(-1, 0, 0);	  offsetValue = vertexData[7];
			break;
		case 7:
			basePoint = Vector3(0, 1, 1); baseValue = vertexData[7];
			offset = Vector3(0, -1, 0);	  offsetValue = vertexData[4];
			break;
		case 8:
			basePoint = Vector3(0, 0, 0); baseValue = vertexData[0];
			offset = Vector3(0, 0, 1);	  offsetValue = vertexData[4];
			break;
		case 9:
			basePoint = Vector3(1, 0, 0); baseValue = vertexData[1];
			offset = Vector3(0, 0, 1);	  offsetValue = vertexData[5];
			break;
		case 10:
			basePoint = Vector3(1, 1, 0); baseValue = vertexData[2];
			offset = Vector3(0, 0, 1);	  offsetValue = vertexData[6];
			break;
		case 11:
			basePoint = Vector3(0, 1, 0); baseValue = vertexData[3];
			offset = Vector3(0, 0, 1);	  offsetValue = vertexData[7];
			break;
		...
		if ((baseValue < 0 && offsetValue < 0) || (baseValue > 0 && offsetValue > 0))
	...
	// In this case, we could have the surface in the top left and bottom right
	// corners, or in the top right and bottom left corners. 
	// Both are equally valid, and we need extra information to determine
	// which is better.
	// 
	// Example:
	// 1 - - - -1      1 - - - -1 
	...
	// This information helps us resolve the ambiguity, telling us which corner the
	// ambiguity resides on.
	// This is also known as the asymptotic decider.
	...
	// In this case, the vertices could be under the same surface (connected to one another
	// through a tunnel), or under different surfaces which are not connected with one another in this voxel.
	// This is a 3D generalization of the 2D face ambiguity above. 
	//
	// Example:
	//     -1________ 1   
	//      /|       /|  
	...
	// If the points are connected through a tunnel, then there must exist some split
	// in the voxel that the points are connected through. We can check for this split by solving
	// for the plane where the 2D face case holds (the center is in the surface).
	...
	bool MarchingCube::testInternalAmbiguity(char caseID, char configID, char subConfigID, char sign)
	{
		...
		// Maintains the reference referenceEdge so we know what two opposite points our ambiguous case is on.
		...
		case  4:
		case 10:
			a = (vertexData[4] - vertexData[0]) * (vertexData[6] - vertexData[2]) - (vertexData[7] - vertexData[3]) * (vertexData[5] - vertexData[1]);
			b = vertexData[2] * (vertexData[4] - vertexData[0]) + vertexData[0] * (vertexData[6] - vertexData[2])
				- vertexData[1] * (vertexData[7] - vertexData[3]) - vertexData[3] * (vertexData[5] - vertexData[1]);
			t = -b / (2 * a);
