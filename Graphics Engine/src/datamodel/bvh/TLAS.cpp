...
BVHRayCast TLAS::raycast(const Vector3& origin, const Vector3& direction) const
{
    BVHRay ray;
    ray.origin = origin;
...
void TLAS::raycastHelper(BVHRay* ray, BVHRayCast* output, UINT node_index) const
{
